...
public partial class VersionWindow : Window
{
    ...
    private void LoadMd()
    {
        try
        {
            string mdPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "version.md");
            if (!File.Exists(mdPath))
            {
                ShowHtml("<p style='color:#999;font-size:18px;font-family:sans-serif;text-align:center;margin-top:100px;'>暂无版本记录</p>");
                return;
            }
